...
\begin{figure*}
	\centering
	\includegraphics[width=0.7\linewidth]{../cost_output_per_storage}
	...
	\label{Fig 2}
\end{figure*}
From the figure we see that configurations 15,14,13 and 5 had considerably high numbers of paths being close to optimal.\\
